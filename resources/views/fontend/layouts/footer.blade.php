        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="dichvu d-flex align-items-center">
                    <img src="{{url('fontend')}}/images/icon-books.png" alt="icon-books">
                    <div class="noidung">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="dichvu d-flex align-items-center">
                    <img src="{{url('fontend')}}/images/icon-ship.png" alt="icon-ship">
                    <div class="noidung">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="dichvu d-flex align-items-center">
                    <img src="{{url('fontend')}}/images/icon-gift.png" alt="icon-gift">
                    <div class="noidung">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="dichvu d-flex align-items-center">
                    <img src="{{url('fontend')}}/images/icon-return.png" alt="icon-return">
                    <div class="noidung">
    ...
    <div class="container py-4">
        <div class="row">
            <div class="col-md-3 col-xs-6">
                <div class="gioithieu">
                    <h3 class="header text-uppercase font-weight-bold">Dịch vụ</h3>
            ...
            <div class="col-md-3 col-xs-6">
                <div class="hotrokh">
                    ...
                    <a href="#">Chính sahcs vận chuyển </a>
                    <a href="#">Chính sách thanh toán và xuất HD</a>
                </div>
            </div>
            <div class="col-md-3 col-xs-6">
                <div class="lienket">
                    <h3 class="header text-uppercase font-weight-bold">HỢP TÁC VÀ LIÊN KẾT</h3>
                    <img src="{{url('fontend')}}/images/dang-ky-bo-cong-thuong.png" alt="dang-ky-bo-cong-thuong">
                </div>
            </div>
            <div class="col-md-3 col-xs-6">
                <div class="ptthanhtoan">
                    <h3 class="header text-uppercase font-weight-bold">Phương thức thanh toán</h3>
                    <img src="{{url('fontend')}}/images/visa-payment.jpg" alt="visa-payment">
                    <img src="{{url('fontend')}}/images/master-card-payment.jpg" alt="master-card-payment">
                    <img src="{{url('fontend')}}/images/jcb-payment.jpg" alt="jcb-payment">
                    <img src="{{url('fontend')}}/images/atm-payment.jpg" alt="atm-payment">
                    <img src="{{url('fontend')}}/images/cod-payment.jpg" alt="cod-payment">
                    <img src="{{url('fontend')}}/images/payoo-payment.jpg" alt="payoo-payment">
                </div>
            </div>
        </div>
    </div>
