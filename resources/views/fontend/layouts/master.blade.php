...
<html lang="vi">
<head>
    <title>@yield('title') shopbook</title>
    ...
    <script type="text/javascript" src="{{url('fontend')}}/js/main.js"></script>
    <link rel="stylesheet" href="{{url('fontend')}}/fontawesome_free_5.13.0/css/all.css">
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@100;300;400;500;700;900&display=swap"
        rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{url('fontend')}}/slick/slick.css" />
    <link rel="stylesheet" type="text/css" href="{{url('fontend')}}/slick/slick-theme.css" />
    <script type="text/javascript" src="{{url('fontend')}}/slick/slick.min.js"></script>
    ...
    <link rel="icon" href="{{url('fontend')}}/images/logo-2.jpg">
    <style>
